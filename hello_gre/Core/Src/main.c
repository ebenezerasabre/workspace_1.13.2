...
//		if(modeSelection == 0) {HAL_GPIO_WritePin(GPIOA, LED_GREEN_Pin, GPIO_PIN_RESET);}
//		else if(modeSelection == 1) {HAL_GPIO_WritePin(GPIOA, LED_GREEN_Pin, GPIO_PIN_SET);}
//		else {HAL_GPIO_TogglePin(GPIOA, LED_GREEN_Pin);}
//		HAL_Delay(500);
