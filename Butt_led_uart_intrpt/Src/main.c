...
#define CR1_RXFNEIE						(1U<<5)			/*RXFIFO not empty interrupt enable*/
#define TCIE							(1U<<6)			/*Transmission complete interrupt enable*/
#define CR1_TXFNFIE						(1U<<7)			/*TXFIFO not full interrupt enable*/
